...
authenticationurl: https://auth.exacttargetapis.com/v1/requestToken?legacy=1""".format(client_id, client_secret))
    ...
    def describe_de(self, args):
        ...
        myDEColumn.search_filter = {'Property' : 'DataExtension.CustomerKey','SimpleOperator' : 'equals','Value' : args.customer_key}
        response = myDEColumn.get()
        return [self.convert_field_to_dict(result, de_target_fields) for result in response.results]
    ...
    def retrieve_triggeredsend(self, args):
        ...
        getTS.search_filter = {'Property' : 'CustomerKey','SimpleOperator' : 'equals','Value' : args.customer_key}
